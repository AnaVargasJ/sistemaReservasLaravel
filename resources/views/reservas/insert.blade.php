...
@section('content')
<br> <br>
    <h2 class="texto-blanco pt-5 pb-3" id="text">Registrar reservacion</h2>
    @if ($errors->any())
    ...
    @endif
    <form class="my-3" action="{{ route('reservas.store') }}" method="post">
        @method('post')
        @csrf
        ...
        <div class="pt-5 pb-3">
            <button type="submit" class="btn btn-info mb-7 float-center" id="lg" onclick="return confirm('¿Desea agregar la silla?')">
